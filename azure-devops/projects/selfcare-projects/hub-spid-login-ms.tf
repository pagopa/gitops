...
module "hub-spid-login-ms_code_review" {
  ...
  local.hub-spid-login-ms-variables_code_review,
  )

  variables_secret = merge(
  local.hub-spid-login-ms-variables_secret,
  local.hub-spid-login-ms-variables_secret_code_review,
  )

...
module "tlscert-prod-firma-io-italia-it-cert_az" {
  ...
  name       = "${var.tlscert-prod-firma-io-italia-it.pipeline.dns_record_name}.${var.tlscert-prod-firma-io-italia-it.pipeline.dns_zone_name}"
  #tfsec:ignore:GEN003
  ...
  dns_zone_resource_group = var.tlscert-prod-firma-io-italia-it.pipeline.dns_zone_resource_group

locals {
  ...
  selc-be-uservice-common-variables_deploy = {
    ...
    dev_user_registry_url      = "https://api.dev.user-registry.pagopa.it/uservice-registry-management/0.1" // TODO
    ...
    uat_user_registry_url      = "https://api.uat.user-registry.pagopa.it/uservice-registry-management/0.1" // TODO
    ...
    prod_user_registry_url      = "https://api.user-registry.pagopa.it/uservice-registry-management/0.1" // TODO
  }
}
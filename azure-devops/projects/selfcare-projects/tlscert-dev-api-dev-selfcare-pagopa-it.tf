variable "tlscert-dev-api-dev-selfcare-pagopa-it" {
  default = {
    repository = {
      organization   = "pagopa"
...
locals {
  ...
  tlscert-dev-api-dev-selfcare-pagopa-it-variables = {
    KEY_VAULT_CERT_NAME          = "${replace(var.tlscert-dev-api-dev-selfcare-pagopa-it.pipeline.dns_record_name, ".", "-")}-${replace(var.tlscert-dev-api-dev-selfcare-pagopa-it.pipeline.dns_zone_name, ".", "-")}"
    KEY_VAULT_SERVICE_CONNECTION = module.DEV-SELFCARE-TLS-CERT-SERVICE-CONN.service_endpoint_name
  }
  tlscert-dev-api-dev-selfcare-pagopa-it-variables_secret = {
  }
}
...
module "tlscert-dev-api-dev-selfcare-pagopa-it-cert_az" {
  ...
  repository                   = var.tlscert-dev-api-dev-selfcare-pagopa-it.repository
  ...
  dns_zone_resource_group = var.tlscert-dev-api-dev-selfcare-pagopa-it.pipeline.dns_zone_resource_group
  ...
  variables = merge(
    var.tlscert-dev-api-dev-selfcare-pagopa-it.pipeline.variables,
    local.tlscert-dev-api-dev-selfcare-pagopa-it-variables,
  )

  variables_secret = merge(
    var.tlscert-dev-api-dev-selfcare-pagopa-it.pipeline.variables_secret,
    local.tlscert-dev-api-dev-selfcare-pagopa-it-variables_secret,
  )

variable "fa-ms-transaction-error-manager" {
  default = {
    repository = {
      organization    = "pagopa"
...
locals {
  # global vars
  fa-ms-transaction-error-manager-variables = {
    dockerfile = "DockerfileV1"
  }
  # global secrets
  fa-ms-transaction-error-manager-variables_secret = {
  ...
  # code_review secrets
  fa-ms-transaction-error-manager-variables_secret_code_review = {

  }
  # deploy vars
  fa-ms-transaction-error-manager-variables_deploy = {
    k8s_image_repository_name            = replace(var.fa-ms-transaction-error-manager.repository.name, "-", "")
    deploy_namespace                     = "fa"
  ...
  # deploy secrets
  fa-ms-transaction-error-manager-variables_secret_deploy = {

  }
}

module "fa-ms-transaction-error-manager_code_review" {
  source = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review?ref=v1.0.0"
  count  = var.fa-ms-transaction-error-manager.pipeline.enable_code_review == true ? 1 : 0

  project_id                   = azuredevops_project.project.id
  repository                   = var.fa-ms-transaction-error-manager.repository
  github_service_connection_id = azuredevops_serviceendpoint_github.io-azure-devops-github-pr.id

  pull_request_trigger_use_yaml = true

  variables = merge(
    local.fa-ms-transaction-error-manager-variables,
    local.fa-ms-transaction-error-manager-variables_code_review,
  )

  variables_secret = merge(
    local.fa-ms-transaction-error-manager-variables_secret,
    local.fa-ms-transaction-error-manager-variables_secret_code_review,
  )
...
module "fa-ms-transaction-error-manager_deploy" {
  source = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy?ref=v1.0.0"
  count  = var.fa-ms-transaction-error-manager.pipeline.enable_deploy == true ? 1 : 0
  ...
  variables = merge(
    local.fa-ms-transaction-error-manager-variables,
    local.fa-ms-transaction-error-manager-variables_deploy,
  )

  variables_secret = merge(
    local.fa-ms-transaction-error-manager-variables_secret,
    local.fa-ms-transaction-error-manager-variables_secret_deploy,
  )
